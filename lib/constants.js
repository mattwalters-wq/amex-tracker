...
export const DEFAULT_SETTINGS = {
  ...
  // Pay + per-payday commitments for forward-looking coverage. Each payday
  // sweeps mortgage/bills/savings out of CBA; only the net is available.
  matt_pay: 2824.61, // Matt's fortnightly pay
  matt_pay_anchor: '2026-06-11', // a known Matt pay date (Thursday); repeats fortnightly
  matt_mortgage: 1160, // Matt's mortgage swept per pay
  matt_bills: 650, // Matt's bills swept per pay
  matt_savings: 300, // Matt's savings swept per pay (discretionary)
  liz_pay: 1600, // Liz's fortnightly pay
  liz_pay_anchor: '2026-06-18', // a known Liz pay date (Thursday); repeats fortnightly
  liz_mortgage: 580, // Liz's mortgage swept per pay
  liz_bills: 320, // Liz's bills swept per pay
  liz_savings: 0, // Liz's savings swept per pay (discretionary)
  include_savings_sweep: true, // include the savings sweep in coverage (discretionary)
}
